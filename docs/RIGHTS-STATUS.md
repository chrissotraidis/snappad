...
Later that day, Chris accepted Preview 3 after completing Beach photo review,
Professor Oak scoring, and next-course progression on the physical iPad. The
same free, unsigned, ROM-free community-release boundary remains in force.
...
The v0.1.0, Preview 2, and Preview 3 releases may include the SnapPad
integration source, patches, scripts, documentation, screenshots, an unsigned
ROM-free IPA, scoped rights notice, and dependency notices. They must not
include any ROM, rebuilt ROM, extracted asset, generated AOT source input,
save, photograph, private log, signing material, or maintainer provisioning
profile.
